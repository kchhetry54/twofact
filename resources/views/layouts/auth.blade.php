...
<html lang="en">
    ...
    <body class="bg-gray-100 ">
        <div class="d-flex flex-column" style="min-height: 100vh">
            ...
            <section class="bg-image d-flex flex-column"
  style="background: url('https://mdbcdn.b-cdn.net/img/Photos/new-templates/search-box/img4.webp') no-repeat center; flex: 1">
            @yield('content')
            </section>
